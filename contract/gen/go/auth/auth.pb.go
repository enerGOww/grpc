...
package energoww_auth_v1_authv1
...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // Registered user email
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // Registered user password
}
...
type RegisterResponse struct {
	...
	UserUuid string `protobuf:"bytes,1,opt,name=user_uuid,json=userUuid,proto3" json:"user_uuid,omitempty"` // Registered user uuid
}
...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`                    // Registered user email
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`              // Registered user password
	AppUuid  string `protobuf:"bytes,3,opt,name=app_uuid,json=appUuid,proto3" json:"app_uuid,omitempty"` // App uuid to login to
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // JWT auth token for logged user
}
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x55, 0x75, 0x69, 0x64, 0x22, 0x5b, 0x0a,
	...
	0x09, 0x52, 0x07, 0x61, 0x70, 0x70, 0x55, 0x75, 0x69, 0x64, 0x22, 0x25, 0x0a, 0x0d, 0x4c, 0x6f,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x19, 0x5a, 0x17, 0x65, 0x6e, 0x65, 0x72, 0x67, 0x6f,
	0x77, 0x77, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x76,
